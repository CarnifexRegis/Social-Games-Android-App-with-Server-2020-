...
public class MonsterDebuffCard extends CardType {
    protected int damageDebuff;


    public MonsterDebuffCard(int typeID, Element element, int manaCost, int damageDebuff){
    ...
    protected void onPlace(EPlayer player, BoardPosition position, int imageID, GameInstance game){ //place on board
        ...
        target.modifyDamageBuffBy(-damageDebuff, position, game);
    }
    @Override
