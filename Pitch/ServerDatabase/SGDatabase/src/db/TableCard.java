		...
		try {
			...
			try {
				...
				String query2 = "CREATE TABLE Card" 
						...
						+ "iid INTEGER NOT NULL," 	// 1 internal id
						+ "category INTEGER NOT NULL," 	// 2 Category : Spell/Monster
						+ "element INTEGER NOT NULL,"	// 3 Element: trivial
						+ "form INTEGER NOT NULL,"		// 4 FORM : specialisation of spell or monster
						+ "atk INTEGER NOT NULL, "		// 5 Attack Value
						+ "def INTEGER NOT NULL,"		// 6 Defensive Value
						+ "pid NOT NULL,"
